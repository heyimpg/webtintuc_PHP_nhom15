            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="">
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">Ngày đăng <span
                                    class="required">*</span>
                            </label>
                            <div class="col-md-8 col-sm-8 ">
                                <input id="birthday" class="date-picker form-control" name="post_date" placeholder="dd-mm-yyyy"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 ">
                                <input id="post_thumbnail" type="file" required="required">
                            </div>
                        </div>
                        <div class="item form-group">
