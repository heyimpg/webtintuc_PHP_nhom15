...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 16, 2021 at 07:06 PM
...
INSERT INTO `chitiettheloai` (`ID_CTTheLoai`, `TenCTTheLoai`, `ID_TheLoai`, `NgayTao`, `NgayCapNhat`) VALUES
(1, 'Văn hoá', 11, NULL, NULL),
(2, 'Giải trí', 22, NULL, NULL),
(3, 'Khoa học', 33, NULL, NULL),
(4, 'Thể thao', 44, NULL, NULL),
(5, 'Kinh doanh', 55, NULL, NULL);
...
--
-- Table structure for table `webtintuc`
--

CREATE TABLE `webtintuc` (
  `C1` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `webtintuc`
--

INSERT INTO `webtintuc` (`C1`) VALUES
('-- phpMyAdmin SQL Dump'),
('-- version 5.1.1'),
('-- https://www.phpmyadmin.net/'),
('--'),
...
--
ALTER TABLE `theloai`
  MODIFY `ID_TheLoai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
